		...
		bio_for_each_segment(bv, bio, i) {
			...
			if (cluster) {
				...
				if (!BIOVEC_SEG_BOUNDARY(q, bvprv, bv))
					goto new_segment;
				/*added patch by jiangsm : don't merge the pages with non-contiguous descriptors 2013-04-03 begain*/
				if ((bvprv->bv_page != bv->bv_page) &&
				    (bvprv->bv_page + 1) != bv->bv_page)
					    goto new_segment;
				/*added patch by jiangsm : don't merge the pages with non-contiguous descriptors 2013-04-03 end*/
